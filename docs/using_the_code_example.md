...
The following example clones the "[PWM-Dual-Compare-Capture](https://github.com/Infineon/mtb-example-psoc-edge-pwm-dual-compare-capture)" application with the desired name "PWMDualCompareCapture" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-pwm-dual-compare-capture --user-app-name PWMDualCompareCapture --target-dir "C:/mtb_projects"
   ```
